...
#define WEIGHTS_PATH "src/xgboost/extracted.data"
#define INPUTS_PATH "src/xgboost/inputs.data"
#define EXPECTED_PATH "src/xgboost/expected_results.data"
...
int main(int argc, char** argv) {
	...
	//weights
	std::ifstream weight_file(WEIGHTS_PATH);
	...
	OCL_CHECK(err, cl::Buffer buffer_weights(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY, vector_weights_size_bytes, initial_weights.data(), &err));
